...
pub async fn get_notification_settings(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        ...
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn set_notification_settings(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.update_settings(settings).await
            .map_err(|e| format!("Falha ao atualizar as configurações: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn request_notification_permission(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.request_permission().await
            .map_err(|e| format!("Falha ao solicitar permissão: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn show_notification(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.show_notification(notification).await
            .map_err(|e| format!("Falha ao exibir a notificação: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn show_test_notification(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.show_test_notification().await
            .map_err(|e| format!("Falha ao exibir a notificação de teste: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn set_manual_dnd(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.set_manual_dnd(enabled).await
            .map_err(|e| format!("Falha ao definir o modo Não Perturbe manual: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn set_notification_consent(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.set_consent(consent).await
            .map_err(|e| format!("Falha ao definir o consentimento: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn clear_notifications(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        manager.clear_notifications().await
            .map_err(|e| format!("Falha ao limpar as notificações: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn initialize_notification_manager_manual(
    ...
    match initialize_notification_manager(app).await {
        ...
        Err(e) => {
            ...
            Err(format!("Falha ao inicializar o gerenciador de notificações: {}", e))
        }
    }
}
...
pub async fn test_notification_with_auto_consent(
    ...
    if manager_lock.is_none() {
        ...
        if let Err(e) = initialize_notification_manager_manual(app.clone(), manager_state.clone()).await {
            return Err(format!("Falha ao inicializar o gerenciador: {}", e));
        }
    } else {
        drop(manager_lock);
    }
    ...
    if let Some(manager) = manager_lock.as_ref() {
        ...
        Err("O gerenciador ainda não foi inicializado".to_string())
    }
}
...
pub async fn get_notification_stats(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        ...
        serde_json::to_value(stats)
            .map_err(|e| format!("Falha ao serializar as estatísticas: {}", e))
    } else {
        Err("Gerenciador de notificações não inicializado".to_string())
    }
}
...
pub async fn show_recording_stopped_notification<R: Runtime>(
    ...
    if let Some(manager) = manager_lock.as_ref() {
        ...
        let title = "ReunIA";
        let body = "A gravação foi interrompida";
