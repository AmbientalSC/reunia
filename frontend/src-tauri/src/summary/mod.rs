...
pub use commands::{
    ...
    __cmd__api_generate_live_insight, __cmd__api_generate_visual_summary,
    __cmd__api_get_visual_summary,
    __tauri_command_name_api_generate_live_insight,
    __tauri_command_name_api_generate_visual_summary,
    __tauri_command_name_api_get_visual_summary, api_generate_live_insight,
    api_generate_visual_summary,
    api_get_visual_summary,
