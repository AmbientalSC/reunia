...
const Sidebar: React.FC = () => {
  ...
  const handleEditConfirm = async () => {
    ...
    if (!newTitle) {
      toast.error("O título da reunião não pode ficar vazio");
      return;
    }
        ...
        <div className="flex flex-col items-center space-y-4 mt-4">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                onClick={() => router.push('/')}
                className={`p-2 rounded-lg transition-colors duration-150 ${isHomePage ? 'bg-ambiental-blue-soft text-ambiental-blue' : 'text-ambiental-gray-mid hover:bg-ambiental-blue-soft hover:text-ambiental-blue'
                  }`}
              >
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              <p>{isRecording ? "Gravação em andamento..." : "Iniciar Gravação"}</p>
            </TooltipContent>
          </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="p-2 rounded-lg transition-colors duration-150 hover:bg-ambiental-blue-hover bg-ambiental-blue-soft"
                >
                  <Upload className="w-5 h-5 text-ambiental-blue" />
                </button>
              </TooltipTrigger>
              <TooltipContent side="right">
                <p>Importar</p>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${isMeetingPage ? 'bg-ambiental-blue-soft text-ambiental-blue' : 'text-ambiental-gray-mid hover:bg-ambiental-blue-soft hover:text-ambiental-blue'
                  }`}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${isSettingsPage ? 'bg-ambiental-blue-soft text-ambiental-blue' : 'text-ambiental-gray-mid hover:bg-ambiental-blue-soft hover:text-ambiental-blue'
                  }`}
              >
      ...
      <div key={item.id}>
        <div
          className={`flex items-center transition-all duration-150 group ${item.type === 'folder' && depth === 0
            ...
            : `px-3 py-2 my-0.5 rounded-md text-sm ${isActive ? 'bg-ambiental-blue-soft text-ambiental-blue font-medium' :
              hasTranscriptMatch ? 'bg-yellow-50' : 'hover:bg-ambiental-blue-soft/60'
            } cursor-pointer`
            }`}
            ...
            {!isCollapsed && (
              <div className="p-3">
                ...
                <div className="relative mb-1">
                  <InputGroup >
                    <InputGroupInput placeholder='Buscar conteúdo da reunião...' value={searchQuery}
