...
function categorizeError(error: string): string {
  ...
  if (lowerError.includes('network') ||
    ...
    lowerError.includes('conex') ||
    lowerError.includes('tempo esgotado') ||
    lowerError.includes('falha ao iniciar o download')) {
    return 'Erro de rede - Verifique sua conexão com a internet';
  }

  if (lowerError.includes('status:') || lowerError.includes('http')) {
    return 'Erro do servidor - Download temporariamente indisponível';
  }

  if (lowerError.includes('disk') ||
    lowerError.includes('write') ||
    lowerError.includes('file') ||
    lowerError.includes('disco') ||
    lowerError.includes('gravar') ||
    lowerError.includes('escrita') ||
    lowerError.includes('arquivo')) {
    return 'Erro de armazenamento - Verifique o espaço em disco disponível';
  }

  if (lowerError.includes('invalid') || lowerError.includes('validation') ||
    lowerError.includes('inválido') || lowerError.includes('validação')) {
    return 'Falha na validação do arquivo - Tente baixar novamente';
  }
