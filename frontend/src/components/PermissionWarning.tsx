        ...
        <Alert variant="destructive" className="border-amber-400 bg-amber-50">
          ...
          <AlertDescription className="text-amber-800 mt-2">
            ...
            {!hasMicrophone && (
              <>
                <p className="mb-3">
                  O ReunIA precisa de acesso ao seu microfone para gravar reuniões. Nenhum dispositivo de microfone foi detectado.
                </p>
                <div className="space-y-2 text-sm mb-4">
                  <p className="font-medium">Verifique:</p>
                  <ul className="list-disc list-inside ml-2 space-y-1">
                    <li>Seu microfone está conectado e ligado</li>
                    <li>A permissão do microfone está concedida nas Configurações do Sistema</li>
                    <li>Nenhum outro aplicativo está usando o microfone exclusivamente</li>
                  </ul>
                </div>
              </>
            )}
            ...
            {!hasSystemAudio && (
              <>
                <p className="mb-3">
                  {hasMicrophone
                    ? 'A captura de áudio do sistema não está disponível. Você ainda pode gravar com seu microfone, mas o áudio do computador não será capturado.'
                ...
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    ...
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      ...
                      <li>Conceda a permissão de Gravação de Tela ao ReunIA</li>
                      <li>Configure o roteamento de áudio no Audio MIDI Setup</li>
                    </ul>
                  </div>
                )}
              </>
