  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-semibold text-gray-800 mb-2">Análises de Uso</h3>
          <p className="text-sm text-gray-600 mb-4">
            As análises de uso estão desativadas por padrão. Você pode ativá-las para compartilhar dados anônimos de produto e desempenho; nenhum conteúdo pessoal é coletado.
          </p>
        </div>

        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div>
            <h4 className="font-semibold text-gray-800">Ativar Análises</h4>
            <p className="text-sm text-gray-600">
              {isProcessing ? 'Atualizando...' : 'Desativadas, a menos que você opte por ativá-las'}
            </p>
          </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-600 mb-2">
                  Compartilhe este ID ao relatar problemas para nos ajudar a investigar os registros do seu problema
                </p>
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 rounded border border-blue-200">
          ...
          <div className="text-xs text-blue-700">
            <p className="mb-1">
              Suas reuniões, transcrições e gravações permanecem totalmente privadas e locais.
            </p>
            <button
