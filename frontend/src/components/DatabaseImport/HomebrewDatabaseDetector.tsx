      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-blue-800 mb-2">
            Encontramos um banco de dados existente da sua instalação anterior do Meetily (versão do backend Python).
          </p>
          ...
          <p className="text-sm text-blue-800 mb-3">
            Gostaria de importar suas reuniões, transcrições e resumos anteriores?
          </p>
