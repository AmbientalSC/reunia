...
export function LegacyDatabaseImport({ isOpen, onComplete }: LegacyDatabaseImportProps) {
  ...
  const handleBrowse = async () => {
    try {
      ...
      if (dbPath) {
        ...
        setErrorMessage('Nenhum banco de dados encontrado no local selecionado. Selecione a pasta do Meetily, a pasta do backend ou o arquivo de banco de dados diretamente.');
  ...
  const handleStartFresh = async () => {
    try {
      ...
      setImportState('success');
      toast.success('Banco de dados inicializado com sucesso! Iniciando o aplicativo...');
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Boas-vindas ao Meetily!</DialogTitle>
          <DialogDescription className="text-base pt-2">
            Você tem dados de uma instalação anterior do Meetily?
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              Selecione a pasta anterior do Meetily, o diretório do backend ou o arquivo de banco de dados:
            </p>
            ...
            >
              {importState === 'selecting' || importState === 'detecting' ? (
                ...
                <>
                  ...
                  <span>Procurar banco de dados</span>
                </>
              )}
            </button>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            >
              Começar do zero (sem importação)
            </button>
          </div>
        </div>
      </DialogContent>
