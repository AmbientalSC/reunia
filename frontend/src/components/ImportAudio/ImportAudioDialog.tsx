        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isProcessing
              ...
              : 'Importe um arquivo de áudio ou um vídeo MP4 da reunião — apenas o áudio será transcrito'}
          </DialogDescription>
        </DialogHeader>
              ...
              {fileInfo ? (
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    MP4 (vídeo ou áudio), MP3, WAV, M4A, FLAC, OGG, MKV, WebM, WMA
                  </p>
                </div>
              )}
                    ...
                    <div className="p-3 pt-0 space-y-4 border-t">
                      ...
                      {!isParakeetModel ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            A seleção de idioma não é compatível com o Parakeet. Ele sempre usa a detecção automática.
                          </p>
                        </div>
                      )}
                      ...
                      {availableModels.length > 0 && (
                        <div className="space-y-2">
                          ...
                          >
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder={loadingModels ? 'Carregando modelos...' : 'Selecionar modelo'} />
                            </SelectTrigger>
                            <SelectContent>
