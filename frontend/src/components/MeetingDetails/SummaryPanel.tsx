...
import { Languages, ChevronDown, FileText, LayoutDashboard } from 'lucide-react';
...
export function SummaryPanel({
  ...
  const [activeView, setActiveView] = useState<'resumo' | 'tela'>('resumo');
  ...
  // Return to the summary view when switching meetings
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const loadSummaryLanguage = async () => {
      try {
        ...
        toast.warning('Não foi possível carregar o idioma de resumo salvo', {
      ...
      while (true) {
        ...
        try {
          ...
          if (
            ...
            if (saved.storage === 'local_fallback') {
              toast.info('Idioma do resumo salvo neste dispositivo', {
                description: 'Esta reunião não tem pasta de gravação, portanto a preferência não pode ser gravada nos metadados da reunião.',
              });
            }
            if (request.language) {
          ...
          if (
            ...
            toast.error('Falha ao salvar o idioma do resumo');
  ...
  return (
    <div className="flex-1 min-w-0 flex flex-col bg-white overflow-hidden">
      {/* Alternância de visualização: Resumo | Tela */}
      <div className="flex items-center justify-center pt-3">
        <Tabs
          value={activeView}
          onValueChange={(value) => {
            const view = value as 'resumo' | 'tela';
            if (view === 'tela') {
              Analytics.trackButtonClick('open_visual_summary_tab', 'meeting_details');
            }
            setActiveView(view);
          }}
        >
          <TabsList>
            ...
            <TabsTrigger value="tela" className="gap-1.5">
      ...
      {activeView === 'tela' ? (
        <VisualSummaryPanel
          ...
          isSummaryGenerating={isSummaryLoading}
        />
      ) : (
        <>
      {/* Title area */}
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center flex-1">
            <div className="text-center">
              ...
              <p className="text-gray-600">Gerando Resumo de IA...</p>
            </div>
          </div>
        </div>
      ) : !aiSummary ? (
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium mb-1">Pontos-Chave</h4>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">Decisões</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">Principais Tópicos</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1">Resumo Completo</h4>
