...
export const MODEL_CONFIGS: Record<string, Partial<ModelInfo>> = {
  ...
  'large-v3': {
    description: 'Maior precisão, ideal para reuniões importantes. Processamento mais lento.',
    size_mb: 2951,
    accuracy: 'High',
    speed: 'Slow'
  },
  'large-v3-turbo': {
    description: 'Melhor precisão com velocidade aprimorada.',
    size_mb: 1549,
    accuracy: 'High',
    speed: 'Medium'
  },
  'medium': {
    description: 'Precisão e velocidade equilibradas. Bom para a maioria dos casos de uso.',
    size_mb: 1463,
    accuracy: 'High',
    speed: 'Slow'
  },
  'small': {
    description: 'Processamento rápido com boa qualidade. Ótimo para transcrições rápidas.',
    size_mb: 466,
    accuracy: 'Good',
    speed: 'Medium'
  },
  ...
  'tiny': {
    description: 'Processamento mais rápido, bom para uso em tempo real.',
    size_mb: 39,
    accuracy: 'Decent',
    speed: 'Very Fast'
  },
  ...
  'tiny-q5_1': {
    description: 'Modelo tiny quantizado, processamento ~50% mais rápido.',
    size_mb: 31,
    accuracy: 'Decent',
    speed: 'Very Fast'
  },
  'base-q5_1': {
    description: 'Modelo base quantizado, bom equilíbrio entre velocidade e precisão.',
    size_mb: 57,
    accuracy: 'Good',
    speed: 'Fast'
  },
  'small-q5_1': {
    description: 'Modelo small quantizado, mais rápido que a versão f16.',
    size_mb: 181,
    accuracy: 'Good',
    speed: 'Fast'
  },
  ...
  'medium-q5_0': {
    description: 'Modelo medium quantizado, qualidade profissional com melhor velocidade.',
    size_mb: 514,
    accuracy: 'High',
    speed: 'Medium'
  },
  'large-v3-turbo-q5_0': {
    description: 'Modelo large turbo quantizado, melhor equilíbrio.',
    size_mb: 547,
    accuracy: 'High',
    speed: 'Medium'
  },
  'large-v3-q5_0': {
    description: 'Modelo large quantizado, melhor equilíbrio entre velocidade e precisão.',
    size_mb: 1031,
    accuracy: 'High',
    speed: 'Slow'
  }
