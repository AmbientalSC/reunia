...
export const MODEL_DISPLAY_CONFIG: Record<string, ModelDisplayInfo> = {
  'parakeet-tdt-0.6b-v3-int8': {
    friendlyName: 'Rápido',
    icon: '⚡',
    tagline: 'Tempo real • Melhor para velocidade, ótima precisão',
    recommended: true,
    tier: 'fastest'
  },
  'parakeet-tdt-0.6b-v2-int8': {
    ...
    icon: '📦',
    tagline: 'Tempo real • Tamanho menor',
    tier: 'balanced'
  },
  'parakeet-tdt-0.6b-v3-fp32': {
    friendlyName: 'Preciso',
    icon: '🎯',
    tagline: '20x tempo real • Precisão maior',
    tier: 'precise'
  }
};
...
export const PARAKEET_MODEL_CONFIGS: Record<string, Partial<ParakeetModelInfo>> = {
  'parakeet-tdt-0.6b-v3-int8': {
    description: 'Tempo real no M4 Max, otimizado para velocidade',
  ...
  'parakeet-tdt-0.6b-v2-int8': {
    description: '25x tempo real, tamanho menor com boa precisão',
  ...
  'parakeet-tdt-0.6b-v3-fp32': {
    description: '20x tempo real no M4 Max, maior precisão',
