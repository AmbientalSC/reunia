...
export function ConfigProvider({ children }: { children: ReactNode }) {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState<string>(() => {
    if (typeof window !== 'undefined') {
      ...
      // Sem idioma de reunião salvo: usa o idioma fixado como padrão do
      // resumo ("Idioma do Resumo") como idioma inicial da transcrição.
      const pinnedSummary = readPinnedSummaryLanguageDefault();
      if (pinnedSummary && LANGUAGES.some((l) => l.code === pinnedSummary)) {
