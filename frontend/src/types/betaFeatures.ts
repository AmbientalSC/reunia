...
export const BETA_FEATURE_NAMES: Record<keyof BetaFeatures, string> = {
  importAndRetranscribe: 'Importar Áudio e Retranscrever',
};
...
export const BETA_FEATURE_DESCRIPTIONS: Record<keyof BetaFeatures, string> = {
  importAndRetranscribe: 'Importe arquivos de áudio para transcrever ou retranscrever reuniões existentes com diferentes configurações de idioma.',
};
