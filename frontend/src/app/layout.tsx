...
// Poppins auto-hospedada (next/font/local) — sem dependência de rede no build.
// Arquivos woff2 em src/assets/fonts/ (subset latin, pesos 100/300/400/600/700).
const poppins = localFont({
  src: [
    { path: '../assets/fonts/poppins-100.woff2', weight: '100', style: 'normal' },
