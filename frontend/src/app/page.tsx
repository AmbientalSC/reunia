            ...
            <div className="fixed bottom-10 left-0 right-0 z-10">
              ...
              >
                <div className="w-2/3 max-w-[750px] flex justify-center">
                  <div className="bg-white rounded-full shadow-xl shadow-gray-900/10 ring-1 ring-gray-900/5 flex items-center p-1.5 hover:shadow-2xl hover:shadow-gray-900/15 transition-shadow duration-300">
                    <RecordingControls
