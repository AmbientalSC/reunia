        ...
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="border-t pt-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Configuração do Modelo de IA</h4>
          ...
          <div className="border-t p-6 flex justify-end">
            <button
              onClick={() => onClose('modelSettings')}
              className="px-4 py-2 text-sm font-medium text-white bg-ambiental-green rounded-md hover:bg-ambiental-green-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ambiental-green"
            >
              Concluir
            </button>
          </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Configurações de Dispositivo de Áudio</h3>
            <button
        ...
        <div className="bg-white rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              {messages.modelSelector ? 'Configuração de Reconhecimento de Fala Necessária' : 'Configurações do Modelo de Transcrição'}
            </h3>
            <button
          ...
          <div className="p-6 pt-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700">Mostrar Indicadores de Confiança</p>
                <p className="text-xs text-gray-500">Exibir pontos coloridos mostrando a qualidade da confiança da transcrição</p>
              </div>
            </div>
            ...
            >
              {messages.modelSelector ? 'Cancelar' : 'Concluir'}
            </button>
          </div>
        </div>
      </div>
